...
def read_from_silver(table: str, spark: SparkSession | None = None) -> DataFrame:
    """Reads a table from the Catalog 'cat_olist' and Schema 'sch_silver'
...
def parse_timestamp(column: Column):
    ...
    Returns:
        Column: The parsed column with the timestamp information
        or NULL in case of parsing failure.
    """
